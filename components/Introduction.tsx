    ...
    return (
        ...
        <header className='lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24'>
            ...
            <ul className="ml-1 mt-8 flex items-center">
                <li className='mr-12 text-xs shrink-0'>
                    <Link href={"https://github.com/nileshshrs"} target="_blank" rel="noreferrer noopener" className='hover:text-slate-200'>
                ...
                <li className='mr-12 text-xs shrink-0'>
                    <Link href={"https://www.linkedin.com/in/nileshshrs/"} target="_blank" rel="noreferrer noopener" className='hover:text-slate-200'>
                ...
                <li className='mr-12 text-xs shrink-0'>
                    <Link href={"https://www.instagram.com/nileshshrs/"} target="_blank" rel="noreferrer noopener" className='hover:text-slate-200'>
